...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn exti0_7(&mut self) -> Exti0_7W<Exticr1Spec> {
        Exti0_7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - GPIO port selection"]
    #[inline(always)]
    #[must_use]
    pub fn exti8_15(&mut self) -> Exti8_15W<Exticr1Spec> {
        Exti8_15W::new(self, 8)
    }
    #[doc = "Bits 16:23 - GPIO port selection"]
    #[inline(always)]
    #[must_use]
    pub fn exti16_23(&mut self) -> Exti16_23W<Exticr1Spec> {
        Exti16_23W::new(self, 16)
    }
    #[doc = "Bits 24:31 - GPIO port selection"]
    #[inline(always)]
    #[must_use]
    pub fn exti24_31(&mut self) -> Exti24_31W<Exticr1Spec> {
