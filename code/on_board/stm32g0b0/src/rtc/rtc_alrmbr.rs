#[doc = "Register `RTC_ALRMBR` reader"]
pub type R = crate::R<RtcAlrmbrSpec>;
#[doc = "Register `RTC_ALRMBR` writer"]
pub type W = crate::W<RtcAlrmbrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn su(&mut self) -> SuW<RtcAlrmbrSpec> {
        SuW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Second tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn st(&mut self) -> StW<RtcAlrmbrSpec> {
        StW::new(self, 4)
    }
    #[doc = "Bit 7 - Alarm B seconds mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk1(&mut self) -> Msk1W<RtcAlrmbrSpec> {
        Msk1W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Minute units in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn mnu(&mut self) -> MnuW<RtcAlrmbrSpec> {
        MnuW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Minute tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn mnt(&mut self) -> MntW<RtcAlrmbrSpec> {
        MntW::new(self, 12)
    }
    #[doc = "Bit 15 - Alarm B minutes mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk2(&mut self) -> Msk2W<RtcAlrmbrSpec> {
        Msk2W::new(self, 15)
    }
    #[doc = "Bits 16:19 - Hour units in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn hu(&mut self) -> HuW<RtcAlrmbrSpec> {
        HuW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Hour tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn ht(&mut self) -> HtW<RtcAlrmbrSpec> {
        HtW::new(self, 20)
    }
    #[doc = "Bit 22 - AM/PM notation"]
    #[inline(always)]
    #[must_use]
    pub fn pm(&mut self) -> PmW<RtcAlrmbrSpec> {
        PmW::new(self, 22)
    }
    #[doc = "Bit 23 - Alarm B hours mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk3(&mut self) -> Msk3W<RtcAlrmbrSpec> {
        Msk3W::new(self, 23)
    }
    #[doc = "Bits 24:27 - Date units or day in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn du(&mut self) -> DuW<RtcAlrmbrSpec> {
        DuW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Date tens in BCD format"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DtW<RtcAlrmbrSpec> {
        DtW::new(self, 28)
    }
    #[doc = "Bit 30 - Week day selection"]
    #[inline(always)]
    #[must_use]
    pub fn wdsel(&mut self) -> WdselW<RtcAlrmbrSpec> {
        WdselW::new(self, 30)
    }
    #[doc = "Bit 31 - Alarm B date mask"]
    #[inline(always)]
    #[must_use]
    pub fn msk4(&mut self) -> Msk4W<RtcAlrmbrSpec> {
        Msk4W::new(self, 31)
    }
}
#[doc = "RTC alarm B register\n\nYou can [`read`](crate::Reg::read) this register and get [`rtc_alrmbr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rtc_alrmbr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RtcAlrmbrSpec;
impl crate::RegisterSpec for RtcAlrmbrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rtc_alrmbr::R`](R) reader structure"]
impl crate::Readable for RtcAlrmbrSpec {}
#[doc = "`write(|w| ..)` method takes [`rtc_alrmbr::W`](W) writer structure"]
impl crate::Writable for RtcAlrmbrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RTC_ALRMBR to value 0"]
impl crate::Resettable for RtcAlrmbrSpec {
