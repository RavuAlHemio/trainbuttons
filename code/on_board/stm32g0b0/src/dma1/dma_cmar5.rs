#[doc = "Register `DMA_CMAR5` reader"]
pub type R = crate::R<DmaCmar5Spec>;
#[doc = "Register `DMA_CMAR5` writer"]
pub type W = crate::W<DmaCmar5Spec>;
...
are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR=1 and the memory destination address if DIR=0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR=1 and the peripheral destination address if DIR=0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN=1)."]
    #[inline(always)]
    #[must_use]
    pub fn ma(&mut self) -> MaW<DmaCmar5Spec> {
        MaW::new(self, 0)
    }
}
#[doc = "DMA channel x memory address register\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_cmar5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_cmar5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCmar5Spec;
impl crate::RegisterSpec for DmaCmar5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cmar5::R`](R) reader structure"]
impl crate::Readable for DmaCmar5Spec {}
#[doc = "`write(|w| ..)` method takes [`dma_cmar5::W`](W) writer structure"]
impl crate::Writable for DmaCmar5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CMAR5 to value 0"]
impl crate::Resettable for DmaCmar5Spec {
