#[doc = "Register `DMA_CMAR4` reader"]
pub type R = crate::R<DmaCmar4Spec>;
#[doc = "Register `DMA_CMAR4` writer"]
pub type W = crate::W<DmaCmar4Spec>;
...
are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR=1 and the memory destination address if DIR=0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR=1 and the peripheral destination address if DIR=0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN=1)."]
    #[inline(always)]
    #[must_use]
    pub fn ma(&mut self) -> MaW<DmaCmar4Spec> {
        MaW::new(self, 0)
    }
}
#[doc = "DMA channel x memory address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dma_cmar4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_cmar4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCmar4Spec;
impl crate::RegisterSpec for DmaCmar4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cmar4::R`](R) reader structure"]
impl crate::Readable for DmaCmar4Spec {}
#[doc = "`write(|w| ..)` method takes [`dma_cmar4::W`](W) writer structure"]
impl crate::Writable for DmaCmar4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CMAR4 to value 0"]
impl crate::Resettable for DmaCmar4Spec {
