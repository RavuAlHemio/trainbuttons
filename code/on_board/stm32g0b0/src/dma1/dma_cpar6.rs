#[doc = "Register `DMA_CPAR6` reader"]
pub type R = crate::R<DmaCpar6Spec>;
#[doc = "Register `DMA_CPAR6` writer"]
pub type W = crate::W<DmaCpar6Spec>;
...
are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory destination address if DIR=1 and the memory source address if DIR=0. In peripheral-to-peripheral mode, this register identifies the peripheral destination address DIR=1 and the peripheral source address if DIR=0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN=1)."]
    #[inline(always)]
    #[must_use]
    pub fn pa(&mut self) -> PaW<DmaCpar6Spec> {
        PaW::new(self, 0)
    }
}
#[doc = "DMA channel x peripheral address register\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_cpar6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_cpar6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCpar6Spec;
impl crate::RegisterSpec for DmaCpar6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cpar6::R`](R) reader structure"]
impl crate::Readable for DmaCpar6Spec {}
#[doc = "`write(|w| ..)` method takes [`dma_cpar6::W`](W) writer structure"]
impl crate::Writable for DmaCpar6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CPAR6 to value 0"]
impl crate::Resettable for DmaCpar6Spec {
