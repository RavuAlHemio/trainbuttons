#[doc = "Register `DMA_CNDTR3` reader"]
pub type R = crate::R<DmaCndtr3Spec>;
#[doc = "Register `DMA_CNDTR3` writer"]
pub type W = crate::W<DmaCndtr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ndt(&mut self) -> NdtW<DmaCndtr3Spec> {
        NdtW::new(self, 0)
    }
}
#[doc = "DMA channel x configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dma_cndtr3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_cndtr3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCndtr3Spec;
impl crate::RegisterSpec for DmaCndtr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cndtr3::R`](R) reader structure"]
impl crate::Readable for DmaCndtr3Spec {}
#[doc = "`write(|w| ..)` method takes [`dma_cndtr3::W`](W) writer structure"]
impl crate::Writable for DmaCndtr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CNDTR3 to value 0"]
impl crate::Resettable for DmaCndtr3Spec {
