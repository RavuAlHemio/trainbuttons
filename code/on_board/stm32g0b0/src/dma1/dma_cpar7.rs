#[doc = "Register `DMA_CPAR7` reader"]
pub type R = crate::R<DmaCpar7Spec>;
#[doc = "Register `DMA_CPAR7` writer"]
pub type W = crate::W<DmaCpar7Spec>;
...
are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory destination address if DIR=1 and the memory source address if DIR=0. In peripheral-to-peripheral mode, this register identifies the peripheral destination address DIR=1 and the peripheral source address if DIR=0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN=1)."]
    #[inline(always)]
    #[must_use]
    pub fn pa(&mut self) -> PaW<DmaCpar7Spec> {
        PaW::new(self, 0)
    }
}
#[doc = "DMA channel x peripheral address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dma_cpar7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_cpar7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCpar7Spec;
impl crate::RegisterSpec for DmaCpar7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cpar7::R`](R) reader structure"]
impl crate::Readable for DmaCpar7Spec {}
#[doc = "`write(|w| ..)` method takes [`dma_cpar7::W`](W) writer structure"]
impl crate::Writable for DmaCpar7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CPAR7 to value 0"]
impl crate::Resettable for DmaCpar7Spec {
