...
impl RegisterBlock {
    ...
    #[doc = "0x24 - counter"]
    #[inline(always)]
    pub const fn cnt_alternate5(&self) -> &CntAlternate5 {
...
#[doc = "counter"]
pub mod cnt;
#[doc = "CNT_ALTERNATE5 (rw) register accessor: counter\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cnt_alternate5::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cnt_alternate5::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cnt_alternate5`]
module"]
#[doc(alias = "CNT_ALTERNATE5")]
pub type CntAlternate5 = crate::Reg<cnt_alternate5::CntAlternate5Spec>;
#[doc = "counter"]
