...
pub type PecbyteR = crate::BitReader<Pecbyte>;
impl PecbyteR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type PecbyteW<'a, REG> = crate::BitWriter<'a, REG, Pecbyte>;
impl<'a, REG> PecbyteW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No PEC transfer."]
...
should be written with the 10-bit slave address to be sent. Note: Changing these bits when the START bit is set is not allowed."]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pecbyte(&mut self) -> PecbyteW<I2cCr2Spec> {
