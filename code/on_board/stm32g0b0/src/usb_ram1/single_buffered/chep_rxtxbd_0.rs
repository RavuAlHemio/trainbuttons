...
#[doc = "Channel/endpoint receive buffer descriptor 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`chep_rxtxbd_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`chep_rxtxbd_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
