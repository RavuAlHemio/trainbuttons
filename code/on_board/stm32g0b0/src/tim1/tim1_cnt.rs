...
pub type R = crate::R<Tim1CntSpec>;
#[doc = "Register `TIM1_CNT` writer"]
pub type W = crate::W<Tim1CntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CntW<Tim1CntSpec> {
        CntW::new(self, 0)
    }
}
...
pub struct Tim1CntSpec;
impl crate::RegisterSpec for Tim1CntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tim1_cnt::R`](R) reader structure"]
impl crate::Readable for Tim1CntSpec {}
#[doc = "`write(|w| ..)` method takes [`tim1_cnt::W`](W) writer structure"]
impl crate::Writable for Tim1CntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIM1_CNT to value 0"]
impl crate::Resettable for Tim1CntSpec {
