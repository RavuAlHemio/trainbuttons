...
pub type R = crate::R<TampBkp1rSpec>;
#[doc = "Register `TAMP_BKP1R` writer"]
pub type W = crate::W<TampBkp1rSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkp(&mut self) -> BkpW<TampBkp1rSpec> {
        BkpW::new(self, 0)
    }
}
#[doc = "TAMP backup 1 register\n\nYou can [`read`](crate::Reg::read) this register and get [`tamp_bkp1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tamp_bkp1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TampBkp1rSpec;
impl crate::RegisterSpec for TampBkp1rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tamp_bkp1r::R`](R) reader structure"]
impl crate::Readable for TampBkp1rSpec {}
#[doc = "`write(|w| ..)` method takes [`tamp_bkp1r::W`](W) writer structure"]
impl crate::Writable for TampBkp1rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TAMP_BKP1R to value 0"]
impl crate::Resettable for TampBkp1rSpec {
