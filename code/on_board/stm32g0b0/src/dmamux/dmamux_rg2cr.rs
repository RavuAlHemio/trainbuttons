...
pub type R = crate::R<DmamuxRg2crSpec>;
#[doc = "Register `DMAMUX_RG2CR` writer"]
pub type W = crate::W<DmamuxRg2crSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sig_id(&mut self) -> SigIdW<DmamuxRg2crSpec> {
        SigIdW::new(self, 0)
    }
    #[doc = "Bit 8 - Trigger overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn oie(&mut self) -> OieW<DmamuxRg2crSpec> {
        OieW::new(self, 8)
    }
    #[doc = "Bit 16 - DMA request generator channel x enable"]
    #[inline(always)]
    #[must_use]
    pub fn ge(&mut self) -> GeW<DmamuxRg2crSpec> {
        GeW::new(self, 16)
    }
    #[doc = "Bits 17:18 - DMA request generator trigger polarity Defines the edge polarity of the selected trigger input"]
    #[inline(always)]
    #[must_use]
    pub fn gpol(&mut self) -> GpolW<DmamuxRg2crSpec> {
        GpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests to be generated (minus 1) Defines the number of DMA requests to be generated after a trigger event. The actual number of generated DMA requests is GNBREQ +1. Note: This field shall only be written when GE bit is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn gnbreq(&mut self) -> GnbreqW<DmamuxRg2crSpec> {
        GnbreqW::new(self, 19)
    }
}
...
pub struct DmamuxRg2crSpec;
impl crate::RegisterSpec for DmamuxRg2crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmamux_rg2cr::R`](R) reader structure"]
impl crate::Readable for DmamuxRg2crSpec {}
#[doc = "`write(|w| ..)` method takes [`dmamux_rg2cr::W`](W) writer structure"]
impl crate::Writable for DmamuxRg2crSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMAMUX_RG2CR to value 0"]
impl crate::Resettable for DmamuxRg2crSpec {
