...
pub type R = crate::R<PdcrdSpec>;
#[doc = "Register `PDCRD` writer"]
pub type W = crate::W<PdcrdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd0(&mut self) -> Pd0W<PdcrdSpec> {
        Pd0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd1(&mut self) -> Pd1W<PdcrdSpec> {
        Pd1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd2(&mut self) -> Pd2W<PdcrdSpec> {
        Pd2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd3(&mut self) -> Pd3W<PdcrdSpec> {
        Pd3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd4(&mut self) -> Pd4W<PdcrdSpec> {
        Pd4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd5(&mut self) -> Pd5W<PdcrdSpec> {
        Pd5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd6(&mut self) -> Pd6W<PdcrdSpec> {
        Pd6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd7(&mut self) -> Pd7W<PdcrdSpec> {
        Pd7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd8(&mut self) -> Pd8W<PdcrdSpec> {
        Pd8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd9(&mut self) -> Pd9W<PdcrdSpec> {
        Pd9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd10(&mut self) -> Pd10W<PdcrdSpec> {
        Pd10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd11(&mut self) -> Pd11W<PdcrdSpec> {
        Pd11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd12(&mut self) -> Pd12W<PdcrdSpec> {
        Pd12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd13(&mut self) -> Pd13W<PdcrdSpec> {
        Pd13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd14(&mut self) -> Pd14W<PdcrdSpec> {
        Pd14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd15(&mut self) -> Pd15W<PdcrdSpec> {
        Pd15W::new(self, 15)
    }
}
...
pub struct PdcrdSpec;
impl crate::RegisterSpec for PdcrdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdcrd::R`](R) reader structure"]
impl crate::Readable for PdcrdSpec {}
#[doc = "`write(|w| ..)` method takes [`pdcrd::W`](W) writer structure"]
impl crate::Writable for PdcrdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PDCRD to value 0"]
impl crate::Resettable for PdcrdSpec {
