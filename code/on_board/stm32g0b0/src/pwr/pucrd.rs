...
pub type R = crate::R<PucrdSpec>;
#[doc = "Register `PUCRD` writer"]
pub type W = crate::W<PucrdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pu0(&mut self) -> Pu0W<PucrdSpec> {
        Pu0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu1(&mut self) -> Pu1W<PucrdSpec> {
        Pu1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu2(&mut self) -> Pu2W<PucrdSpec> {
        Pu2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu3(&mut self) -> Pu3W<PucrdSpec> {
        Pu3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu4(&mut self) -> Pu4W<PucrdSpec> {
        Pu4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu5(&mut self) -> Pu5W<PucrdSpec> {
        Pu5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu6(&mut self) -> Pu6W<PucrdSpec> {
        Pu6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu7(&mut self) -> Pu7W<PucrdSpec> {
        Pu7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu8(&mut self) -> Pu8W<PucrdSpec> {
        Pu8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu9(&mut self) -> Pu9W<PucrdSpec> {
        Pu9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu10(&mut self) -> Pu10W<PucrdSpec> {
        Pu10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu11(&mut self) -> Pu11W<PucrdSpec> {
        Pu11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu12(&mut self) -> Pu12W<PucrdSpec> {
        Pu12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu13(&mut self) -> Pu13W<PucrdSpec> {
        Pu13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu14(&mut self) -> Pu14W<PucrdSpec> {
        Pu14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port D pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu15(&mut self) -> Pu15W<PucrdSpec> {
        Pu15W::new(self, 15)
    }
}
...
pub struct PucrdSpec;
impl crate::RegisterSpec for PucrdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pucrd::R`](R) reader structure"]
impl crate::Readable for PucrdSpec {}
#[doc = "`write(|w| ..)` method takes [`pucrd::W`](W) writer structure"]
impl crate::Writable for PucrdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PUCRD to value 0"]
impl crate::Resettable for PucrdSpec {
